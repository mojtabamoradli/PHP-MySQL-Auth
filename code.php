        ...
        <div class="row d-flex justify-content-center align-items-center h-10">
          <div class="col-12 col-md-8 col-lg-6 col-xl-5">
            <div class="card-body p-1 text-center">
              ...
              <h5 class="mb-5 ">Please enter the code sent to your email.</h5>
              <form method="POST">
                <div class="form-outline mb-2">
                  <input type="text" name="recover-code" placeholder="Code" class="form-control py-2 mb-2">


                  <button id="btn-dark" class="btn btn-success float-left"> Recover Account </button>
              </form>
            </div>
          </div>
        </div>
